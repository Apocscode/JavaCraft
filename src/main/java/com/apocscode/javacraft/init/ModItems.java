...
import com.apocscode.javacraft.item.DiskItem;
import com.apocscode.javacraft.item.GlassesItem;
...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(JavaCraft.MODID);
    ...
    public static final DeferredItem<SpawnEggItem> DRONE_SPAWN_EGG = ITEMS.register("drone_spawn_egg",
            () -> new SpawnEggItem(ModEntities.DRONE.get(), 0x333333, 0x00AAFF, new Item.Properties()));
