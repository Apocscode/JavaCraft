...
/**
 * Command-line shell for JavaCraft OS.
...
public class ShellProgram extends OSProgram {
    ...
    public void init(JavaOS os) {
        this.os = os;
        appendOutput("JavaCraft OS v1.0\n");
    ...
    private void cmdHelp() {
        appendOutput("=== JavaCraft Shell Commands ===\n");
        ...
        switch (parts[0].toLowerCase()) {
            case "send" -> {
                ...
                try {
                    ...
                    com.apocscode.javacraft.network.BluetoothNetwork.broadcastFromDevice(
